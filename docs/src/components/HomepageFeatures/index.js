...
const FeatureList = [
  {
    ...
    description: (
      <>
        Learn Django, Docker, PostgreSQL, and more. Build professional-grade REST
        APIs with Python.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        No more outdated tutorials. Use Python 3.9+ and the latest versions of
        every Django extension and library.
      </>
    ),
  },
  {
