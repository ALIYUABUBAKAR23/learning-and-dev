...
class User(AbstractUser):
    ...
    def get_user_list(cls, **kwargs):
        ...
        """
        users = User.objects.filter(**kwargs).values("first_name","last_name","middle_name","id","sex","state_of_origin","address","date_of_birth","department_id","phone_number","email")
        return users