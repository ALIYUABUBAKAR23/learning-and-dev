...
class GetCustomers(APIView):
    ...
    def post(self, request):
        ...
        if customer_data is None:
            return Response(
                data={"message": "could not create customer profile.Try again"}, status=status.HTTP_501_NOT_IMPLEMENTED
            )
    ...
    def put(self, request):
        ...
        if customer is None:
            return Response(
                data={"message": "Failed to update customer profile."}, status=status.HTTP_501_NOT_IMPLEMENTED
            )
    ...
    def delete(self, request):
        ...
        if customer is None:
            return Response(
                data={"message": "Failed to delete customer profile."}, status=status.HTTP_501_NOT_IMPLEMENTED
            )
